      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-2">
        ...
        <div className="flex items-center gap-2 flex-1">
          <input
            ...
            className="min-w-[120px] w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-transparent text-sm"
            minLength={3}
            maxLength={20}
            pattern="[a-zA-Z0-9_-]+"
            disabled={disabled}
